...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content clearfix"><?php if ( function_exists( 'get_the_image' ) ) { get_the_image(array( 'width' => 100, 'height' => 100, 'thumbnail_id_save' => true, 'image_class' => 'wp-post-image', 'default_image' => 'http://medonline.at/wp-content/uploads/medONLINE_128.png' )); } ?>
